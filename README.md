...
Hello, my name is Tea. I am a fullstack software engineer with experience using JavaScript, TypeScript, Python,C#, MongoDB, SQL, SQLite, MySQL, Express, Prisma, React, React Native, Redux, Node, Firebase, and Android Studio, with a background in game development, graphic design, special education, and adult education, leading with accessibility at every step of development.
